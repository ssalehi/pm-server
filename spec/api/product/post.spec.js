...
describe("Post product suggestion", () => {
    ...
    lib.dbHelpers.dropAll().then(res => {
      ...
      Promise.all([
        ...
        let productsArr = [{
          ...
          colors: [{color_id: colorIds[0], images: ['image001', 'image002'],}]
        }, {
          name: 'product 002',
          ...
          colors: [{color_id: colorIds[1], images: []}]
        }, {
          name: 'product 003',
          brand: mongoose.Types.ObjectId(),
          product_type: mongoose.Types.ObjectId(),
          base_price: 3000,
          desc: 'this is description about product 003',
        }, {
          name: 'product 004',
          brand: mongoose.Types.ObjectId(),
          product_type: mongoose.Types.ObjectId(),
          base_price: 4000,
          desc: 'this is description about product 004',
        }, {
          name: 'product 005',
          brand: mongoose.Types.ObjectId(),
          product_type: mongoose.Types.ObjectId(),
          base_price: 5000,
          desc: 'this is description about product 005',
        }, {
          name: 'product 006',
          brand: mongoose.Types.ObjectId(),
          product_type: mongoose.Types.ObjectId(),
          base_price: 6000,
          desc: 'this is description about product 006',
        }];
  ...
  it("should return list of products when search by name", function (done) {
    ...
    rp({
      ...
      expect(res.body[0]._id).toEqual(productIds[0].toString());
      done();
