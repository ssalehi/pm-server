...
// Login API
router.post('/agent/login', passport.authenticate('local', {}), apiResponse('Person', 'afterLogin', false, ['user', () => 'agent']));
...
router.get('/validUser/:personType', apiResponse('Person', 'afterLogin', false, ['user', 'params.personType']));
