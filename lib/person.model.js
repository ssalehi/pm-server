...
class Person extends Base {
  ...
  async static passportLocalStrategy(req, username, password, done) {
    try {
  ...
  async static passportOAuthStrategy(req, token, refreshToken, profile, done) {
    try {
  ...
  async static jwtStrategy(req, isAgent = false) {
  ...
  async  static appOauthLogin(body) {
    let data = {
      username: body.email,
      secret: null,
