...
class Person extends Base {
  ...
  load(username, password, personType, access_level) {
    ...
    if (personType === PersonType.Customer)
      searchData = Object.assign({
        $or: [{username: username}, {mobile_no: username}],
  ...
  afterLogin(user, isAgent) {
    ...
    // don't use this.PersonModel here. because current instance of person is made be api response without modelName.
