...
class Page extends Base {
  ...
  search(options, offset, limit) {
    ...
    const match = (options.is_app !== null && options.is_app !== undefined) ? {address: {$regex: phrase, $options: 'i'}, is_app: options.is_app ? "true" : "false"} : {address: {$regex: phrase, $options: 'i'}};
