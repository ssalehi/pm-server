...
class Delivery extends Base {
  ...
  getDeliveryAgentItems(user, isDelivered, deliveryStatusList) {
    if (!deliveryStatusList.length)
    ...
    let statusCondition = [];
    deliveryStatusList.forEach(el => {
      statusCondition.push({'last_status.status': el});
    });
