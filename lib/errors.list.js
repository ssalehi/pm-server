...
let productInstanceNotExist = new Error("This product instance does not exist for this product");
...
let productIsSoldOut = new Error('this product is sold out and thus can\'t be added to the cart');
productIsSoldOut.statusCode = 500;
...
let generateSignatureFailed = new Error("Generate Digital Sign Failed");
generateSignatureFailed.status = 412;
...
let artistNameIsRequired = new Error("artist name is required");
artistNameIsRequired.status = 404;

let trackNameIsRequired = new Error("track name is required");
trackNameIsRequired.status = 404;

let trackIdIsRequired = new Error("track id is required");
trackIdIsRequired.status = 404;

let workingOnFile = new Error("system is working on a file");
workingOnFile.status = 456;

let notEnoughBalance = new Error("not enough balance for fully payment by balance");
notEnoughBalance.statusCode = 404;
