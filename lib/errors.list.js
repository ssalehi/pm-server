...
let invalidInvoice = new Error("Invoice information doesn't match with the original invoice");
invalidInvoice.status = 403;

let soldOutBeforePayment = new Error("product is sold out right before payment");
invalidInvoice.status = 500;
