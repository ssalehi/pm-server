...
let ownerCardNameIsRequired = new Error("Owner card name is required");
ownerCardNameIsRequired.status = 404;

let ownerCardSurnameIsRequired = new Error("Owner card surname is required");
ownerCardSurnameIsRequired.status = 404;
...
module.exports = {
  ...
  ownerCardNameIsRequired,
  ownerCardSurnameIsRequired
};
