...
const SMMessage = require('./sm_message.model');
...
class Search {
  ...
  constructor(test = Search.test) {
    this.libs = {
      ...
      Ticket: {Class: Ticket, access_level: [_const.ACCESS_LEVEL.SalesManager, _const.ACCESS_LEVEL.ShopClerk, _const.ACCESS_LEVEL.HubClerk]},
      DeliveryTicket: {
        Class: DeliveryTicket, access_level: [
      ...
      SoldOut: {Class: SoldOut, access_level: [_const.ACCESS_LEVEL.ContentManager]},
      SMMessage: {Class: SMMessage, access_level: [_const.ACCESS_LEVEL.SalesManager]}
    };
