...
class Customer extends Person {
  ...
  setPreferences(body) {
    ...
    if (!mongoose.Types.ObjectId.isValid(body.customerId)) return Promise.reject(error.invalidId);

    return this.CustomerModel.update({_id: body.customerId}, {
      $set: {
        preferred_size: body.preferred_size,
