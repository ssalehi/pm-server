...
class Customer extends Person {
  ...
  getWishListItems(user) {
    ...
    return this.CustomerModel.aggregate(
      ...
      res.forEach(el => {
        el.product.instances.forEach( i => {
          let index = el.product.instances.indexOf(i);
          if (i._id !== el.wish_list.product_instance_id)
            el.instances.splice(index,1);
        })
      })
  ...
  //         $project: {
  //           pi_comp: {
  //             $cmp: ['$instances._id', '$product_instance_id']
  //           },
  //           product: 1,
  //           username: 1,
  //           _id: 1,
