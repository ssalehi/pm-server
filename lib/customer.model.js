      ...
      this.generateCode()
        .then(res => {
          ...
          return this.CustomerModel.findOneAndUpdate({
            ...
            $set: {
              /* should NOT reverse the mobile verification level, because it would log out
              the already-verified user from system and he wouldn't be able to login again! */
              // is_verified: this.getNewVerificationLevel(res[0].is_verified, this.verificationItems.mobile, true),
              mobile_no: mobile_no,
