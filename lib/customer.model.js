...
class Customer extends Person {
  ...
  setMobileNumber(body) {
    ...
    return new Promise((resolve, reject) => {
      this.generateCode()
        .then(res => {
          return this.CustomerModel.findOneAndUpdate({username: body.username, is_verified: false}, {$set: {mobile_no: body.mobile_no, verification_code: res, is_verified: false}});
        })
        .then(res => {
