    ...
    return this.insertBrands()
      ...
      .then(res => {
          ...
          let makeProduct = row => {
            ...
            let typeId = results.types.find(x => x.name === row[Dictionary.Division.excelName])._id;
            ...
            let price = row[Dictionary.Price.excelName];
            ...
            return models['Product' + (Upload.test ? 'Test' : '')].findOneAndUpdate(query, update, options).lean()
              ...
              .then(res => {
                ...
                res = res.toObject();
                let productColorId = res.colors.find(x => x.color_id.equals(colorId))._id;
                    ...
                    "instances": {
                      $not: {
                        $elemMatch: {
                          ...
                          "size": row[Dictionary.Size.excelName]
                        }
                      }
                    },
                  },
