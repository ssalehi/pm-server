...
Dictionary = {
  ...
  // -> says that whether to set the soldout mark in the soldout table or not (if exists)
  // * should handle reversing the soldouts if an already-soldout product is added
  // * adding new warehouse items should not create new element in array, but instead update the count in the already-existing warehouse!
