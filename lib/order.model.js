...
class Order extends Base {
  ...
  sendDataToBank(user, data) {
    ...
    const redirectAddress = "http://localhost/checkout";
    const timeStamp = time;
    const invoiceNumber = mongoose.Types.ObjectId().toString();
    const invoiceDate = time;
    const pemKey = `-----BEGIN PRIVATE KEY-----

-----END PRIVATE KEY-----`
    console.log(pemKey);
    // pem key is above
    ...
    // const sh1String = sha1(dataString);

    // const pemKey = new RSAXML().exportPemKey(env.private_key);
    // const signKey = new NodeRSA([pemKey, 'pkcs1'], {
    //   signingScheme: {
    //     scheme: 'pkcs1',
    //     hash: 'sha1', //hash using for scheme
    //   }
    // });
    // const signedString = signKey.sign(dataString, 'base64', 'utf8');
    const sign = crypto.createSign('SHA1');
    sign.write(dataString, 'utf8');
    sign.end();
    const signedString = sign.sign(pemKey, 'base64');
    console.log({pemKey, signedString, dataString});
//     const verifyKey = new NodeRSA([`-----BEGIN PUBLIC KEY-----
// MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC3sju7dnvd6w3s5k2XenDCLjUC
// 1PVjEvF34KFeqZiFLv5q6nC+j4IHwr1KE+9LuE5+hfVoHVXBniiA9GT1FjPmJg6V
// KWxxcbhTDM9ufda9JIEGHppjtbJ/ne0r6VIHzYAjW1yWcc5izI9rS++KGlg39anf
// hET054slb8bOrC05WwIDAQAB
// -----END PUBLIC KEY-----`],{
//         signingScheme: {
//           scheme: 'pkcs1',
//           hash: 'sha1', //hash using for scheme
//         }
//       });
//     console.log({verify: verifyKey.verify(dataString,signedString, 'utf8', 'base64')});
    const bankDataObj = {
