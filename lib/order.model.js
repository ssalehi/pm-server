...
class Order extends Base {
  ...
  checkoutCart(user, cartItems, orderId, address, customerData,
    ...
    console.log('isCollect :', is_collect);
    console.log('-----------------------');
    ...
    if (user && user.access_level === undefined) {
      ...
      const guestUser = customerData;
      address.recipient_email = customerData.recipient_email;
