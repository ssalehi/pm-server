...
class Order extends Base {
  ...
  async prepareDataForBankGateway(user, data) {
    console.log(data.duration_days);
    ...
    // using delivery duration days recieved from client (data.duration_days)
    ...
    try {
      let signedString;
      // total_amount = 1000; // only for test, should remove later
