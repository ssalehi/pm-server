...
class Ticket extends Base {
  ...
  async setOrderLineAsDamaged(order, orderLine, userId, salesManagerId) {
    try {

      return this.setTicket(order, orderLine, _const.ORDER_LINE_STATUS.Damaged, userId, salesManagerId);
    } catch (err) {
      console.log('-> error on set order line as cancel requested ', err);
      throw err;
    }
