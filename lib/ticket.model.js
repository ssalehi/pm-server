...
class Ticket extends Base {
  ...
  async setOrderLineAsWaitForDamageWithRefund(order, orderLine, userId, warehouseId) {
    try {

      return this.setTicket(order, orderLine, _const.ORDER_LINE_STATUS.WaitForDamageWithRefund, userId, warehouseId);
    } catch (err) {
  ...
  async setOrderLineAsWaitForDamageWithoutRefund(order, orderLine, userId, warehouseId) {
    try {

      return this.setTicket(order, orderLine, _const.ORDER_LINE_STATUS.WaitForDamageWithoutRefund, userId, warehouseId);
    } catch (err) {
