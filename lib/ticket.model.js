...
class Ticket extends Base {
  ...
  async setOrderLineAsCancelRequested(order, orderLine, userId, warehouseId) {
    try {
      return this.setTicket(order, orderLine, _const.ORDER_LINE_STATUS.CancelRequested, userId, warehouseId);
    } catch (err) {
