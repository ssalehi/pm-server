...
class Ticket extends Base {
  ...
  async setOrderLineAsWaitingForLostWarehouse(order, orderLine, userId, warehouseId) {
    try {
  ...
  async setOrderLineAsReturned(order, orderLine, userId, warehouesId) {
    try {
      return this.setTicket(order, orderLine, _const.ORDER_LINE_STATUS.Returned, customerId, salesManagerId);
    } catch (err) {
      console.log('-> error on set order line as returned', err);
      throw err;
    }
  }
