...
class Ticket {
  ...
  searchShopInbox(receiverId, offset, limit, is_collect) {
    return is_collect ? this.collectShopSearch(receiverId, offset, limit) : this.normalShopSearch(receiverId, offset, limit);
  }

  collectShopSearch(receiverId, offset, limit) {
    const result = {
      mainQuery: [],
      countQuery: []
    };
  ...
  normalShopSearch(receiverId, offset, limit) {
    const result = {
      mainQuery: [],
      countQuery: []
    };
